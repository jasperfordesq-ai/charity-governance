...
- `npm run test:production-check`
  - Passed on 2026-07-09 with 316/316 production-tooling checks passing.
...
- `npm run test:production-check`
  - Passed again with 316/316 production-tooling checks after launch-evidence and continuation-doc hardening.
