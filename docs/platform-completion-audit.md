...
Working-tree base commit when generated: `d824090`
...
| Irish compliance model | 12 matrix entries; last checked 2026-07-04; statuses guidance:6, conditional:3, not_commenced:2, in_force:1. | Refresh official sources before legal copy changes and record professional-review signoff outside git. |
...
- `npm run test:e2e` passed locally with 78/78 Playwright checks across accessibility, auth, compliance, documents, responsive route smoke, and tenant-isolation flows.
...
| P0 | `/export` | dashboard | `apps/web/src/app/(dashboard)/export/page.tsx` | 336 | yes | no obvious static risk; verify in browser |
