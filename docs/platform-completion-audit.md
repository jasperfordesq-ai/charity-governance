...
| P0 | `/registers` | dashboard | `apps/web/src/app/(dashboard)/registers/page.tsx` | 541 | yes | large route file; refactor soon; dark-mode relies mostly on layout; screenshot QA required |
