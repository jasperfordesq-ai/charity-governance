...
Working-tree base commit when generated: `6b25ac6`
...
| --- | --- | --- |
| Product UI | 25 page routes scanned; 15 are P0 trustee/compliance workflows; 8 route files are 450+ lines. | Refactor and browser-QA the largest P0 workflows first: /registers (1123), /documents (869), /deadlines (725), /board (654), /organisation (602), /export (576). |
