...
Working-tree base commit when generated: `fc95d33`
...
| --- | --- | --- |
| Product UI | 25 page routes scanned; 15 are P0 trustee/compliance workflows; 7 route files are 450+ lines. | Refactor and browser-QA the largest P0 workflows first: /registers (1123), /documents (776), /deadlines (626), /organisation (602), /board (594), /compliance/[principleId] (573). |
...
| P0 | `/board` | dashboard | `apps/web/src/app/(dashboard)/board/page.tsx` | 594 | yes | large route file; refactor soon; 1 inline svg icon(s); decorative or pill-heavy styling needs visual QA |
