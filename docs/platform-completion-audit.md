...
Working-tree base commit when generated: `d76d7c4`
...
| --- | --- | --- |
| Product UI | 25 page routes scanned; 15 are P0 trustee/compliance workflows; 6 route files are 450+ lines. | Refactor and browser-QA the largest P0 workflows first: /registers (846), /documents (776), /deadlines (626), /compliance/[principleId] (573), /board (565), /organisation (511). |
...
| P0 | `/registers` | dashboard | `apps/web/src/app/(dashboard)/registers/page.tsx` | 846 | yes | oversized route file; split first |
