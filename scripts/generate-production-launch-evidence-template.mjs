...
const evidenceHintsByCheck = new Map([
  ...
  ['releaseGate.deploy-smoke', ['node scripts/smoke-production-deploy.mjs --production-env-file .env.production', 'https://app.charitypilot.ie', 'https://api.charitypilot.ie']],
